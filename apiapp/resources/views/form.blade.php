                        ...
                        <div class="col-md-12 grid-margin">
                            <div class="row">
                                <div class="col-12 col-xl-8 mb-4 mb-xl-3">
                                    ...
                                    <h6 class="font-weight-normal mb-0">Have A nice day!!
                                    </h6>
                                </div>
                            ...
                            {{-- <div > --}}
                            <form class="row" action="{{ url('/posting-products') }}" method="post"
                                ...
                                <div class="mb-3 col-6">
                                    <label for="exampleInputtext1" class="form-label">inStock</label>
                                ...
                                <div class="mb-3 col-6">
                                    ...
                                    <input type="number" class="form-control" name="numReviews"
                                        id="exampleInputPassword1">
                                </div>
